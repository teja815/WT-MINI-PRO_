        ...
        <div className="relative overflow-hidden rounded-2xl border border-red-200 bg-brand-red p-8 text-white shadow-sm">
          ...
          <div className="relative">
            ...
            <p className="mt-3 max-w-md text-sm text-white/90">
              Sign in using Firebase Authentication. Your complaint will be <span className="font-semibold text-brand-yellow">verified by Admin</span> before it reaches the Faculty dashboard.
            </p>
                ...
                <button
                  ...
                  className={[
                    ...
                    role === opt.id
                      ...
                      : 'border-gray-200 hover:border-brand-sky hover:bg-sky-50'
                  ].join(' ')}
                >
